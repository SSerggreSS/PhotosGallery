...
//  PhotosGallery
//
//  Created by Сергей  Бей on 01.12.2020.
//
...
class ImageScrollView: UIScrollView, UIScrollViewDelegate {
    ...
    func configurateFor(imageSize: CGSize) {
        ...
        setCurrentMaximumAndMinimumScale()
    ...
    private func setCurrentMaximumAndMinimumScale() {
    ...
    func zoom(point: CGPoint, animated: Bool) {
        ...
        let zoomRectangle = zoomRect(scale: finalScale, center: point)
        self.zoom(to: zoomRectangle, animated: true)
